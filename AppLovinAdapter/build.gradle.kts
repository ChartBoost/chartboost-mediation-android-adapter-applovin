...
android {
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "4.11.5.5.0"
        buildConfigField("String", "HELIUM_APPLOVIN_ADAPTER_VERSION", "\"${android.defaultConfig.versionName}\"")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                pom {
                    name.set("Helium Adapter AppLovin")
